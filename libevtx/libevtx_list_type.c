...
{
	static char *function = "libevtx_list_element_initialize";
	...
	*element = memory_allocate_structure(
	...
	if( memory_set(
	     *element,
	     0,
	     sizeof( libevtx_list_element_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
...
int libevtx_list_element_free(
     ...
     libcerror_error_t **error )
{
	static char *function = "libevtx_list_element_free";
	int result            = 1;
...
int libevtx_list_element_get_value(
     ...
     libcerror_error_t **error )
{
	static char *function = "libevtx_list_element_get_value";
...
int libevtx_list_element_set_value(
     ...
     libcerror_error_t **error )
{
	static char *function = "libevtx_list_element_set_value";
...
int libevtx_list_initialize(
     ...
     libcerror_error_t **error )
{
	static char *function = "libevtx_list_initialize";
...
int libevtx_list_free(
     ...
     libcerror_error_t **error )
{
	static char *function = "libevtx_list_free";
	int result            = 0;
...
int libevtx_list_empty(
     ...
     libcerror_error_t **error )
{
	libevtx_list_element_t *list_element = NULL;
	static char *function                = "libevtx_list_empty";
	int element_index                    = 0;
...
int libevtx_list_clone(
     ...
     libcerror_error_t **error )
{
	libevtx_list_element_t *source_list_element = NULL;
	intptr_t *destination_value                 = NULL;
	static char *function                       = "libevtx_list_clone";
	int element_index                           = 0;
...
int libevtx_list_get_number_of_elements(
     ...
     libcerror_error_t **error )
{
	static char *function = "libevtx_list_get_number_of_elements";
...
{
	libevtx_list_element_t *list_element = NULL;
	static char *function                = "libevtx_list_get_element_by_index";
...
{
	libevtx_list_element_t *list_element = NULL;
	static char *function                = "libevtx_list_get_value_by_index";
	int result                           = 0;

	result = libevtx_list_get_element_by_index(
	          list,
	          element_index,
	          &list_element,
	          error );
	...
	if( libevtx_list_element_get_value(
	     list_element,
	     value,
	     error ) != 1 )
	{
...
int libevtx_list_prepend_element(
     ...
     libcerror_error_t **error )
{
	static char *function = "libevtx_list_prepend_element";
...
{
	libevtx_list_element_t *list_element = NULL;
	static char *function                = "libevtx_list_prepend_value";

	if( libevtx_list_element_initialize(
	     &list_element,
	     error ) != 1 )
	{
		libcerror_error_set(
	...
	if( libevtx_list_prepend_element(
	     list,
	     list_element,
	     error ) != 1 )
	{
	...
	if( libevtx_list_element_set_value(
	     list_element,
	     value,
	     error ) != 1 )
	{
...
int libevtx_list_append_element(
     ...
     libcerror_error_t **error )
{
	static char *function = "libevtx_list_append_element";
...
{
	libevtx_list_element_t *list_element = NULL;
	static char *function                = "libevtx_list_append_value";
	...
	if( libevtx_list_append_element(
	     list,
	     list_element,
	     error ) != 1 )
	{
 ...
 * The value_compare_function should return LIBEVTX_LIST_COMPARE_LESS,
 * LIBEVTX_LIST_COMPARE_EQUAL, LIBEVTX_LIST_COMPARE_GREATER if successful or -1 on error
 *
 * Duplicate entries are allowed by default and inserted after the last duplicate value.
 * Only allowing unique entries can be enforced by setting the flag LIBEVTX_LIST_INSERT_FLAG_UNIQUE_ENTRIES
 *
...
{
	libevtx_list_element_t *list_element = NULL;
	static char *function                = "libevtx_list_insert_element";
	int element_index                    = 0;
	int result                           = -1;
	...
	if( ( insert_flags & ~( LIBEVTX_LIST_INSERT_FLAG_UNIQUE_ENTRIES ) ) != 0 )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_ARGUMENTS,
	...
	else
	{
		     ...
		     element_index++ )
		{
			...
			else if( result == LIBEVTX_LIST_COMPARE_EQUAL )
			{
				if( ( insert_flags & LIBEVTX_LIST_INSERT_FLAG_UNIQUE_ENTRIES ) != 0 )
				{
					return( 0 );
			...
			else if( result == LIBEVTX_LIST_COMPARE_LESS )
			{
				break;
			}
			else if( result != LIBEVTX_LIST_COMPARE_GREATER )
			{
				libcerror_error_set(
				 error,
				 LIBCERROR_ERROR_DOMAIN_ARGUMENTS,
		...
		if( result == LIBEVTX_LIST_COMPARE_LESS )
		{
...
{
	libevtx_list_element_t *list_element = NULL;
	static char *function                = "libevtx_list_insert_value";
	int result                           = 0;
	...
	result = libevtx_list_insert_element(
	          list,
	          list_element,
...
int libevtx_list_remove_element(
     ...
     libcerror_error_t **error )
{
	static char *function = "libevtx_list_remove_element";
