     ...
     liberror_error_t **error )
{
	 ...
	 */
	if( libevtx_table_get_number_of_columns(
	     table,
	     &number_of_columns,
	     0,
	     error ) != 1 )
...
#if defined( LIBCSTRING_HAVE_WIDE_SYSTEM_CHARACTER )
		result = libevtx_column_get_utf16_name_size(
		          column,
		          &value_string_size,
		          error );
#else
		result = libevtx_column_get_utf8_name_size(
		          column,
		          &value_string_size,
		          error );
#endif
...
#if defined( LIBCSTRING_HAVE_WIDE_SYSTEM_CHARACTER )
		result = libevtx_column_get_utf16_name(
		          column,
		          (uint16_t *) value_string,
		          value_string_size,
		          error );
#else
		result = libevtx_column_get_utf8_name(
		          column,
	 ...
	 */
	if( libevtx_table_get_number_of_records(
	     table,
	     &number_of_records,
	     error ) != 1 )
	{
     ...
     liberror_error_t **error )
{
	...
	if( libevtx_table_get_number_of_indexes(
	     table,
	     &number_of_indexes,
	     error ) != 1 )
	{
...
#if defined( LIBCSTRING_HAVE_WIDE_SYSTEM_CHARACTER )
		result = libevtx_index_get_utf16_name_size(
			  index,
			  &index_name_size,
			  error );
#else
		result = libevtx_index_get_utf8_name_size(
			  index,
			  &index_name_size,
			  error );
#endif
...
#if defined( LIBCSTRING_HAVE_WIDE_SYSTEM_CHARACTER )
		result = libevtx_index_get_utf16_name(
			  index,
			  (uint16_t *) index_name,
			  index_name_size,
			  error );
#else
		result = libevtx_index_get_utf8_name(
			  index,
			  (uint8_t *) index_name,
			  index_name_size,
			  error );
     ...
     liberror_error_t **error )
{
	 ...
	 */
	if( libevtx_index_get_number_of_columns(
	     index,
	     &number_of_columns,
	     0,
	     error ) != 1 )
	 ...
	 */
	if( libevtx_index_get_number_of_records(
	     index,
	     &number_of_records,
	     error ) != 1 )
	{
     ...
     liberror_error_t **error )
{
	...
	if( libevtx_record_get_number_of_values(
	     record,
	     &number_of_values,
	     error ) != 1 )
	{
     ...
     liberror_error_t **error )
{
	...
	libcstring_system_character_t *value_string = NULL;
        libevtx_long_value_t *long_value           = NULL;
        libevtx_multi_value_t *multi_value         = NULL;
	...
	if( libevtx_record_get_column_identifier(
	     record,
	     record_value_entry,
	     &column_identifier,
	     error ) != 1 )
	...
	if( libevtx_record_get_column_type(
	     record,
	     record_value_entry,
	     &column_type,
	     error ) != 1 )
	...
	if( ( value_flags & ~( LIBEVTX_VALUE_FLAG_VARIABLE_SIZE ) ) == 0 )
	{
		switch( column_type )
		{
			case LIBEVTX_COLUMN_TYPE_BOOLEAN:
				result = libevtx_record_get_value_boolean(
					  record,
					  record_value_entry,
					  &value_8bit,
					  error );
			...
			case LIBEVTX_COLUMN_TYPE_INTEGER_8BIT_UNSIGNED:
				result = libevtx_record_get_value_8bit(
					  record,
					  record_value_entry,
					  &value_8bit,
					  error );
			...
			case LIBEVTX_COLUMN_TYPE_INTEGER_16BIT_SIGNED:
			case LIBEVTX_COLUMN_TYPE_INTEGER_16BIT_UNSIGNED:
				result = libevtx_record_get_value_16bit(
					  record,
					  record_value_entry,
					  &value_16bit,
					  error );
				...
				{
					if( column_type == LIBEVTX_COLUMN_TYPE_INTEGER_16BIT_SIGNED )
					{
						fprintf(
						 record_file_stream,
						 "%" PRIi16 "",
			...
			case LIBEVTX_COLUMN_TYPE_INTEGER_32BIT_SIGNED:
			case LIBEVTX_COLUMN_TYPE_INTEGER_32BIT_UNSIGNED:
				result = libevtx_record_get_value_32bit(
					  record,
					  record_value_entry,
					  &value_32bit,
					  error );
				...
				{
					if( column_type == LIBEVTX_COLUMN_TYPE_INTEGER_32BIT_SIGNED )
					{
						fprintf(
						 record_file_stream,
						 "%" PRIi32 "",
			...
			case LIBEVTX_COLUMN_TYPE_CURRENCY:
			case LIBEVTX_COLUMN_TYPE_INTEGER_64BIT_SIGNED:
				result = libevtx_record_get_value_64bit(
					  record,
					  record_value_entry,
					  &value_64bit,
					  error );
				...
				{
					if( column_type == LIBEVTX_COLUMN_TYPE_INTEGER_64BIT_SIGNED )
					{ 
						fprintf(
						 record_file_stream,
						 "%" PRIi64 "",
			...
			case LIBEVTX_COLUMN_TYPE_DATE_TIME:
				result = libevtx_record_get_value_filetime(
					  record,
					  record_value_entry,
					  &value_64bit,
					  error );
			...
			case LIBEVTX_COLUMN_TYPE_FLOAT_32BIT:
				result = libevtx_record_get_value_floating_point_32bit(
				          record,
				          record_value_entry,
				          &value_float,
				          error );
			...
			case LIBEVTX_COLUMN_TYPE_DOUBLE_64BIT:
				result = libevtx_record_get_value_floating_point_64bit(
				          record,
				          record_value_entry,
				          &value_double,
				          error );
			...
			case LIBEVTX_COLUMN_TYPE_TEXT:
			case LIBEVTX_COLUMN_TYPE_LARGE_TEXT:
#if defined( LIBCSTRING_HAVE_WIDE_SYSTEM_CHARACTER )
				result = libevtx_record_get_value_utf16_string_size(
					  record,
					  record_value_entry,
					  &value_string_size,
					  error );
#else
				result = libevtx_record_get_value_utf8_string_size(
					  record,
					  record_value_entry,
					  &value_string_size,
					  error );
...
#if defined( LIBCSTRING_HAVE_WIDE_SYSTEM_CHARACTER )
					result = libevtx_record_get_value_utf16_string(
					          record,
					          record_value_entry,
					          (uint16_t *) value_string,
					          value_string_size,
					          error );
#else
					result = libevtx_record_get_value_utf8_string(
					          record,
					          record_value_entry,
					          (uint8_t *) value_string,
					          value_string_size,
	...
	else if( ( value_flags & LIBEVTX_VALUE_FLAG_COMPRESSED ) != 0 )
	{
		switch( column_type )
		{
			case LIBEVTX_COLUMN_TYPE_LARGE_TEXT:
	...
	else if( ( value_flags & LIBEVTX_VALUE_FLAG_LONG_VALUE ) != 0 )
	{
		if( libevtx_record_get_long_value(
		     record,
		     record_value_entry,
		     &long_value,
		     error ) != 1 )
		...
		if( libevtx_long_value_get_number_of_segments(
		     long_value,
		...
		{
			if( libevtx_long_value_get_segment_data(
			     long_value,
			     long_value_segment_iterator,
			     &value_data,
			     &value_data_size,
...
libsystem_notify_print_data(
 ...
 value_data_size );
	...
	else if( ( ( value_flags & LIBEVTX_VALUE_FLAG_MULTI_VALUE ) != 0 )
	      && ( ( value_flags & 0x10 ) == 0 ) )
	{
		/* TODO what about non string multi values ?
		 */
		if( libevtx_record_get_multi_value(
		     record,
		     record_value_entry,
		     &multi_value,
		     error ) != 1 )
		...
		if( libevtx_multi_value_get_number_of_values(
		     multi_value,
		...
		{
			if( libevtx_multi_value_get_value(
			     multi_value,
			     multi_value_iterator,
			     &column_type,
			     &value_data,
			...
			if( value_data != NULL )
			{
				if( ( column_type == LIBEVTX_COLUMN_TYPE_TEXT )
				 || ( column_type == LIBEVTX_COLUMN_TYPE_LARGE_TEXT ) )
				{
#if defined( LIBCSTRING_HAVE_WIDE_SYSTEM_CHARACTER )
					result = libevtx_multi_value_get_value_utf16_string_size(
						  multi_value,
						  multi_value_iterator,
						  &value_string_size,
						  error );
#else
					result = libevtx_multi_value_get_value_utf8_string_size(
						  multi_value,
						  multi_value_iterator,
						  &value_string_size,
						  error );
...
#if defined( LIBCSTRING_HAVE_WIDE_SYSTEM_CHARACTER )
						result = libevtx_multi_value_get_value_utf16_string(
						          multi_value,
						          multi_value_iterator,
						          (uint16_t *) value_string,
						          value_string_size,
						          error );
#else
						result = libevtx_multi_value_get_value_utf8_string(
						          multi_value,
						          multi_value_iterator,
						          (uint8_t *) value_string,
						          value_string_size,
