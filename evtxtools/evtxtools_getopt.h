...
typedef struct evtxtools_option evtxtools_option_t;

struct evtxtools_option
{
...
void evtxtools_getopt_wrapped_fprint(
      FILE *stream,
...
void evtxtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const evtxtools_option_t *options,
      int number_of_options );

int evtxtools_getopt_get_options_string(
     const evtxtools_option_t *options,
     int number_of_options,
