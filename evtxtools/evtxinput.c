 ...
 */
int evtxinput_determine_ascii_codepage(
     const libcstring_system_character_t *string,
     int *ascii_codepage,
     liberror_error_t **error )
{
	static char *function = "evtxinput_determine_ascii_codepage";
	...
	if( string_length == 5 )
	{
		if( libcstring_system_string_compare(
		     ...
		     5 ) == 0 )
		{
			*ascii_codepage = LIBEVTX_CODEPAGE_ASCII;
			result          = 1;
		}
	}
				  ...
				  4 ) == 0 )
			{
				...
				else if( string_length == 10 )
				{
					if( libcstring_system_string_compare(
					     ...
					     1 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_1;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_2;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_3;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_4;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_5;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_6;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_7;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_8;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  1 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_9;
						result          = 1;
					}
				}
				else if( string_length == 11 )
				{
					if( libcstring_system_string_compare(
					     ...
					     2 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_10;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  2 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_11;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  2 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_13;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  2 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_14;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  2 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_15;
						result          = 1;
					}
					else if( libcstring_system_string_compare(
						  &( string[ 9 ] ),
						  ...
						  2 ) == 0 )
					{
						*ascii_codepage = LIBEVTX_CODEPAGE_ISO_8859_16;
						result          = 1;
					}
				}
			}
