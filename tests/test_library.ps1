...
Foreach (${TestName} in ${LibraryTests} -split " ")
{
	...
	$ResultRun = RunTestBinary ${TestExecutablesDirectory} "evtx_test_${TestName}"
...
Foreach (${TestName} in ${LibraryTestsWithInput} -split " ")
{
	...
	{
		$ResultRun = RunTestBinaryWithInput ${TestExecutablesDirectory} "evtx_test_${TestName}" ${TestInput}
